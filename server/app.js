...
const { EmailClient: RealEmailClient } = require("@azure/communication-email");
const cors = require('cors');
require('dotenv').config();

const createApp = (EmailClientClass = RealEmailClient) => {
    const app = express();
    ...
    try {
        if (connectionString) {
            emailClient = new EmailClientClass(connectionString);
